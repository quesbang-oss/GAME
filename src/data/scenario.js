...
// すべての画像パスを一括管理
// Viteの仕組み上、publicフォルダ内のファイルは先頭を / にします
export const ASSETS = {
  backgrounds: {
  ...
  sprites: {
    // リース（表情差分）: 階層に合わせて bg/ を追加
    reese_normal: "/images/bg/sprites/tuuzyou-reese.png",
    reese_closed: "/images/bg/sprites/metuburu-reese.png",
    reese_surprised: "/images/bg/sprites/odoroki-reese.png",
    reese_laugh: "/images/bg/sprites/nikkoreese.png",
    reese_goofy: "/images/bg/sprites/huzakereese.png",
    reese_angry: "/images/bg/sprites/kirereese.png",
    reese_awakened: "/images/bg/sprites/kakusei-reese.png",
    ...
    // 画像一覧にないものは、必要に応じて追加または修正してください
